...
class ClearSleepRecording extends StatefulWidget {
  const ClearSleepRecording({super.key});

  @override
  State<ClearSleepRecording> createState() => _ClearSleepRecordingState();
}

class _ClearSleepRecordingState extends State<ClearSleepRecording> {
  @override
